  ...
  return (
    <YStack space="$4" alignItems="center" paddingVertical="$8">
      <YStack space="$2" alignItems="center" maxWidth={600}>
        <H2 textAlign="center" fontSize="$10" data-testid="homepage-title">
      ...
      <YStack space="$3" alignItems="center" marginTop="$6">
        ...
        <Link to="/dreams">
          <Button size="$4" variant="outlined" data-testid="view-journal-button">
            View Dream Journal
          </Button>
        </Link>
      </YStack>
      ...
      <YStack space="$4" marginTop="$8" maxWidth={800}>
        <H2 fontSize="$7" textAlign="center" data-testid="features-heading">
          Features
        </H2>
